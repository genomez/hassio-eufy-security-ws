...
> `genomez/eufy-security-client#passport-profile-response-compat` to test nested
> regional passport-profile response envelopes. It is separate from the normal
> `wake-v4` add-on and is not intended as a general update.
...
- Custom **eufy-security-client** from GitHub (`genomez/eufy-security-client#passport-profile-response-compat`)
